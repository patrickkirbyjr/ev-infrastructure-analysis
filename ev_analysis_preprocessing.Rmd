...
import US DoE data on alternative fueling stations
...
drop PR and DC (focusing on states only)
...
calculate electric vehicles per charging station for each state
...
calculate number of people per charging station based on population

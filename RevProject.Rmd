...
ggsave("figures/evs_per_charging_station_us.png", bg = "grey")
...
ggsave("figures/people_per_charging_station_us.png", bg = "grey")
...
ggsave("figures/ev_saturation_by_population.png", bg = "grey")
...
ggsave("figures/ev_charging_station_gaps_by_state.png", bg = "grey")
```
...
ggsave("figures/top_10_underbuilt_states.png")
```
